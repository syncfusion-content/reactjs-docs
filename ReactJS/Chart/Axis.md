...
description: Learn here all about Axis Support in Syncfusion Essential Studio ReactJS Chart Control, its elements, and more.
platform: ReactJS
control: Chart
documentation: ug
api : /api/js/ejchart
...
![ReactJS Chart Axis](/js/Chart/Axis_images/axis_img1.png)
...
![ReactJS Chart Category axis isIndexed](/js/Chart/Axis_images/axis_img51.png)
...
![ReactJS Chart numeric interval](/js/Chart/Axis_images/axis_img6.png)
...
![ReactJS Chart Round axis range](/js/Chart/Axis_images/axis_img9.png)
...
![ReactJS Chart rangePadding Axis](/js/Chart/Axis_images/axis_img10.png)
...
![ReactJS Chart Normal Axis](/js/Chart/Axis_images/axis_img11.png)
...
![ReactJS Chart starting range of the axis](/js/Chart/Axis_images/axis_img66.png)
...
![ReactJS Chart DateTime Axis](/js/Chart/Axis_images/axis_img12.png)
...
![ReactJS Chart Chart before rounding axis range](/js/Chart/Axis_images/axis_img16.png)


**Chart after rounding axis range**

![ReactJS Chart Chart after rounding axis range](/js/Chart/Axis_images/axis_img17.png)
...
![ReactJS Chart Additional Axis](/js/Chart/Axis_images/axis_img18.png)
...
![ReactJS Chart DateTime Category range](/js/Chart/Axis_images/axis_img64.png)
...
![ReactJS Chart Logarithmic range](/js/Chart/Axis_images/axis_img20.png)
...
![ReactJS Chart Format numeric labels](/js/Chart/Axis_images/axis_img23.png)
...
![ReactJS Chart Axis](/js/Chart/Axis_images/axis_img54.png)
...
![ReactJS Chart Positioning the axis elements](/js/Chart/Axis_images/axis_img67.png)
...
![ReactJS Chart Axis](/js/Chart/Axis_images/axis_img62.png)
...
![ReactJS Chart Label customization Axis](/js/Chart/Axis_images/axis_img28.png)
...
![ReactJS Chart Grid lines Axis](/js/Chart/Axis_images/axis_img32.png)
...
![ReactJS Chart Tick lines Axis](/js/Chart/Axis_images/axis_img33.png)
...
![ReactJS Chart Inversing axis](/js/Chart/Axis_images/axis_img34.png)


**Chart after inversing the axes**

![ReactJS Chart after Inversing Axis](/js/Chart/Axis_images/axis_img35.png)
...
![ReactJS Chart Chart before setting maximum labels](/js/Chart/Axis_images/axis_img38.png)


**Chart after setting maximum labels one per 100 pixels**

![ReactJS Chart Chart after setting maximum labels](/js/Chart/Axis_images/axis_img39.png)
...
![ReactJS Chart rotate45 Axis](/js/Chart/Axis_images/axis_img43.png)
...
![ReactJS Chart rotate90 Axis](/js/Chart/Axis_images/axis_img44.png)
...
![ReactJS Chart wrap](/js/Chart/Axis_images/axis_img45.png)
...
![ReactJS Chart hide](/js/Chart/Axis_images/axis_img47.png)
...
![ReactJS Chart Customizing the multi-Level labels](/js/Chart/Axis_images/axis_img58.png)
...
![ReactJS Chart Axis](/js/Chart/Axis_images/axis_img59.png)
...
![ReactJS Chart textAlignment](/js/Chart/Axis_images/axis_img60.png)
