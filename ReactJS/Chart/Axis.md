...
![Category Axis in ReactJS Chart](Axis_images/axis_img1.png)
...
![Place labels on ticks in ReactJS Chart](Axis_images/axis_img2.png)
...
[Display labels after a fixed interval in ReactJS Chart](Axis_images/axis_img3.png)
...
![Indexed Category Axis in ReactJS Chart](Axis_images/axis_img50.png)

**While Category axis isIndexed value false**

![Category axis is lndexed in ReactJS Chart](Axis_images/axis_img51.png)
...
![Numeric Axis in ReactJS Chart](Axis_images/axis_img4.png)
...
![Customize numeric range in ReactJS Chart](Axis_images/axis_img5.png)
...
![Customize numeric interval in ReactJS Chart](Axis_images/axis_img6.png)
...
![Apply padding to the range in ReactJS Chart](Axis_images/axis_img7.png)
...
![Before rounding axis range in ReactJS Chart](Axis_images/axis_img8.png)



**Chart after rounding axis range**

![After rounding axis range in ReactJS Chart](Axis_images/axis_img9.png)
...
![Additional in ReactJS Chart](Axis_images/axis_img10.png)
...
![Normal in ReactJS Chart](Axis_images/axis_img11.png)
...
![Customizing the starting range of the axis in ReactJS Chart](Axis_images/axis_img66.png)
...
![Date time axis in ReactJS Chart](Axis_images/axis_img12.png)
...
![Customizing date time range in ReactJS Chart](Axis_images/axis_img13.png)
...
![Date time interval in ReactJS Chart](Axis_images/axis_img14.png)
...
![Apply padding to the range in ReactJS Chart](Axis_images/axis_img15.png)
...
![Before rounding axis range in ReactJS Chart](Axis_images/axis_img16.png)


**Chart after rounding axis range**

![After rounding axis range in ReactJS Chart](Axis_images/axis_img17.png)
...
![Additional average sales comparison in ReactJS Chart](Axis_images/axis_img18.png)
...
![Date time category axis in ReactJS Chart](Axis_images/axis_img63.png)
...
![Customizing date time category range in ReactJS Chart](Axis_images/axis_img64.png)
...
![Logarithmic axis in ReactJS Chart](Axis_images/axis_img19.png)
...
![Customize Logarithmic Range in ReactJS Chart](Axis_images/axis_img20.png)
...
![logarithmic base in ReactJS Chart](Axis_images/axis_img21.png)
...
![Format numeric label in ReactJS Chart](Axis_images/axis_img23.png)
...
![Format date time value in ReactJS Chart](Axis_images/axis_img24.png)
...
![Custom Label Format in ReactJS Chart](Axis_images/axis_img25.png)
...
![Axis Crossing in ReactJS Chart](Axis_images/axis_img52.png)
...
![Crossing a Specific Axis in ReactJS Chart](Axis_images/axis_img53.png)
...
![Placing axis in the opposite side in ReactJS Chart](Axis_images/axis_img54.png)
...
![Crossing in date time axis in ReactJS Chart](Axis_images/axis_img55.png)
...
![Crossing in category Axis in ReactJS Chart](Axis_images/axis_img56.png)
...
![Positionig the axis element while crossing in ReactJS Chart](Axis_images/axis_img67.png)
...
![Axis visibility in ReactJS Chart](Axis_images/axis_img26.png)
...
![Axis title in ReactJS Chart](Axis_images/axis_img27.png)
...
![Modify the position of the axis title in ReactJS Chart](Axis_images/axis_img62.png)
...
![label customization in ReactJS Chart](Axis_images/axis_img28.png)
...
![label and tick positioning in ReactJS Chart](Axis_images/axis_img29.png)
...
![Before setting edge label placement to X axis in ReactJS Chart](Axis_images/axis_img30.png)


**Chart after setting edge label placement to X-axis**

![Chart after setting edge label placement to X axis in ReactJS Chart](Axis_images/axis_img31.png)
...
![Grid lines Customization in ReactJS Chart](Axis_images/axis_img32.png)
...
![Tick line customization in ReactJS Chart](Axis_images/axis_img33.png)
...
![Inversing the axis in ReactJS Chart](Axis_images/axis_img34.png)


**Chart after inversing the axes**

![After inversing the axis in ReactJS Chart](Axis_images/axis_img35.png)
...
![X and Y axis at normal position in ReactJS Chart](Axis_images/axis_img36.png)
...
![After setting maximum labels one per 100 pixels in ReactJS Chart](Axis_images/axis_img39.png)
...
![Chart Multiple Axis in ReactJS Chart](Axis_images/axis_img40.png)
...
![Additional horizontal in ReactJS Chart](Axis_images/axis_img41.png)
...
![Smart Axis labels in ReactJS Chart](Axis_images/axis_img42.png)
...
! [Set as wrap in ReactJS Chart](Axis_images/axis_img45.png)
...
![Multiple row in ReactJS Chart](Axis_images/axis_img48.png)
...
![Wrap by word in ReactJS Chart](Axis_images/axis_img49.png)
...
![Customizing the Multi level lables in ReactJS Chart](Axis_images/axis_img58.png)
...
![Text and Font Properties in ReactJS Chart](Axis_images/axis_img59.png)
...
![Text Alignment in ReactJS Chart](Axis_images/axis_img60.png)
...
![Trimmed Multi Level lables in ReactJS Chart](Axis_images/axis_img61.png)
